...
We will now examine the arguments that can be passed to the function to improve the results of the clustering. 
...
![Figure Dashboard for Hierarchical Clustering Method](./images/hierarchical_clustering_dashboard.jpeg)

While for a partitional clustering, the dendrogram will be replaced by a silhouette plot as shown below.

![Figure Dashboard for Hierarchical Clustering Method](./images/partitional_clustering_dashboard.jpeg)
