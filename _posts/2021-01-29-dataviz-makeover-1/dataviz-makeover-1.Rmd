...
### Update
The final visualisation deviates slightly from the original plan. The changes are as the following:
...
![Figure 13. Create Calculated Field](./images/4.2. Create Calculated Field.png)
...
![Figure 14. Total Resident Labour Force Formula](./images/4.2. Total Resident Labour Force Formula.png)
...
![Figure 15. Go to Sheet](./images/4.2. Go to Sheet.png)
...
![Figure 16. Tableau Layout](./images/4.2. Tableau Interface-marked.png)
...
![Figure 17. Rows and Columns for Line Chart](./images/4.2. Rows and Columns Line Chart.png)
...
![Figure 18. Add Age Group](./images/4.2. Add Age Group.png)
...
#### Label
![Figure 19. Add Label](./images/4.2. Add Label.png)
...
![Figure 20. Format Label](./images/4.2. Format Label.png)
...
![Figure 21. Remove Axis](./images/4.2. Remove Header.png)

* **Right-click** on the y-axis > **Uncheck Show Header**.

![Figure 22. Hide Field Labels for Columns](./images/4.2. Hide Field Labels for Columns.png)
...
#### Line Markers
![Figure 23. Add Markers](./images/4.2. Add Markers.png)
...
![Figure 24. Rename Sheet Name](./images/4.2. Rename Sheet Name.png) 
...
![Figure 25. Change Sheet Title](./images/4.2. Sheet Title.png)
...
![Figure 26. Annotate Mark](./images/4.2. Annotate Mark.png)

* **Right-click** on one of the data point > **Annotate** > **Mark...**.

![Figure 27. Annotation](./images/4.2. Annotation.png)
...
![Figure 28. Final Look for Singapore Resident Labour Force Line Chart](./images/4.2. Final Look for Singapore Resident Labour Force Line Chart.png)
...
![Figure 30. Add Filters](./images/4.3. Add Filters.png)
...
![Figure 31. Live Connection](./images/4.3. Live Connection.png)
...
![Figure 32. Labour Force Participation Rate Percentage Change Formula](./images/4.3. LFPR Percentage Change Formula.png)
...
![Figure 33. Add New Worksheet](./images/4.3. New Worksheet.png) 
...
![Figure 34. Rows and Columns for Labour Force Participation Rate Bar Chart](./images/4.3. Rows and Columns for Labour Force Participation Rate Bar Chart.png)
...
![Figure 35. Add Colour and Label](./images/4.3. Add Color and Label.png)
...
![Figure 36. Change Colour](./images/4.3. Change Colour.png)
...
![Figure 37. Customise Label](./images/4.3. Customise Label.png)
...
![Figure 38. Final Look for Labour Force Participation Rate Change](./images/4.3. Final Look for Labour Force Participation Rate Change.png)
...
![Figure 39. Final Look for Population Size Change Bar Chart](./images/4.4. Final Look for Population Size Change.png)

## 4.5. Dashboard
Now, it is time to combine the various charts that we have created.

![Figure 40. New Dashboard](./images/4.5. New Dashboard.png)

* To create new dashboard, click the **New Dashboard Tab**, which is the second tab to the right of our last worksheet.

![Figure 41. Dashboard Size](./images/4.5. Dashboard Size.png)
...
![Figure 42. Insert Sheet to Dashboard](./images/4.5. Insert Sheet to Dashboard.png)
...
![Figure 43. Vertical Object](./images/4.5. Vertical Object.png)
...
![Figure 44. Remove Legend](./images/4.5. Remove Legends.png)
...
![Figure 45. Show Dashboard Title](./images/4.5. Show Dashboard Title.png)

To create a title and lead-in for the dashboard, we can either use a Text object or use the dashboard title itself. The checkbox highlighted in Figure 45 will make the dashboard title appear.

![Figure 46. Final Dashboard Layout](./images/4.5. Dashboard Layout - marked.png)
...
![Figure 47. Singapore Resident Labour Force Alternative Graphical Representation](./images/Final Dashboard.png)
