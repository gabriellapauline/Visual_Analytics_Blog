...
![Figure 17. Rows and Columns for Line Chart](./images4.2. Rows and Columns Line Chart.png)
...
Just like the sheet title, we can customise the annotation and make use of the variables using the **Insert** button. And now, we are done for this line chart! 
...
![Figure 28. Add New Data Source](./images/4.3. New Data Source.png)
...
![Figure 29. Add Filters](./images/4.3. Add Filters.png)
...
![Figure 30. Live Connection](./images/4.3. Live Connection.png)
...
![Figure 31. Labour Force Participation Rate Percentage Change Formula](./images/4.3. LFPR % Change Formula.png)
...
![Figure 32. Add New Worksheet](./images/4.3. New Worksheet.png) 
